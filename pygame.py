...
PREGUNTES = [
    ...
    {'pregunta': 'El Llibre Blanc (LBEA) recomana a les empreses "Fomentar la sensibilització i participació dels..."', 'tipus': 'opcions', 'opcions': {'a': 'Clients', 'b': 'Accionistes', 'c': 'Treballadors', 'd': 'Proveïdors'}, 'correcta': 'c', 'nivell': 'expert', 'feedback': 'El LBEA destaca la importància d\'implicar la plantilla en les polítiques de sostenibilitat de l\'empresa.', 'ambit': 'Polítiques i Acords'},
...
def go_to_state(new_state):
    ...
    session_keys_to_delete = ['preguntes', 'guanys_sessio', 'pregunta_actual_idx', 'resposta_enviada', 'resposta_correcta', 'session_correctes', 'session_performance_ambit', 'timer_start']
...
if st.session_state.estat_joc != 'inici':
    ...
    with cols_header[1]:
        ...
        st.markdown(f"<p style='text-align: center;'>{st.session_state.nom_jugador}</p>", unsafe_allow_html=True)
    with cols_header[2]:
