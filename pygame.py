...
PREGUNTES = [
    ...
    # ... i la resta de les 120 preguntes van aquí (escurçat per brevetat en aquesta finestra de codi) ...
]
...
if st.session_state.estat_joc == 'inici':
    ...
    col3.metric("Precisió", f"{(st.session_state.get('session_correctes', 0) / 10) * 100:.0f}%")
