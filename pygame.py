...
PREGUNTES_EDAFOLOGIA = [
    ...
    {"pregunta": "Un horitzó de transició amb característiques intermèdies entre A i B es anomenaria...", "opcions": ["Horitzó A/B", "Horitzó C", "Horitzó AB", "Horitzó BA"], "resposta_correcta": "Horitzó AB", "gc_guany": 45, "gc_perdua": 25, "dificultat": 2, "categoria": "Horitzons"},
    ...
    {"pregunta": "Què tendeix a passar amb el pH del sòl a causa de les precipitacions?", "opcions": ["Tendeix a alcalinitzar-se", "No té cap efecte", "Tendeix a acidificar-se", "Es neutralitza sempre a 7"], "resposta_correcta": "Tendeix a acidificar-se", "gc_guany": 80, "gc_perdua": 40, "dificultat": 4, "categoria": "Propietats Químiques"},
    ...
    {"pregunta": "Quin factor condiciona el tipus de meteorització i els fluxos verticals d'aigua i sals?", "opcions": ["El temps", "Els organismes", "La topografia", "El clima"], "resposta_correcta": "El clima", "gc_guany": 115, "gc_perdua": 55, "dificultat": 5, "categoria": "Factors de Formació"},
    {"pregunta": "Per què es considera el sòl un recurs NO renovable?", "opcions": ["Perquè no es pot moure", "Perquè el seu temps de formació és extremadament lent", "Perquè sempre és de color fosc", "Perquè no conté aigua"], "resposta_correcta": "Perquè el seu temps de formació és extremadament lent", "gc_guany": 130, "gc_perdua": 65, "dificultat": 5, "categoria": "Edafogènesi"},
    ...
    {"pregunta": "En el cicle del nitrogen, la conversió de nitrogen gas (N₂) en formes aprofitables per les plantes es diu...", "opcions": ["Nitrificació", "Desnitrificació", "Fixació", "Amonificació"], "resposta_correcta": "Fixació", "gc_guany": 150, "gc_perdua": 75, "dificultat": 6, "categoria": "Cicles Biogeoquímics"},
