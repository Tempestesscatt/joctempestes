...
# Pla de Carrera Professional (Exàmens) - COSTOS REEQUILIBRATS
EXAMENS_INFO = [
    {"id": 1, "nom": "Fonaments de la Comunicació", "cost": 0, "nivell_dificultat": 1},
    {"id": 2, "nom": "Certificat en Assertivitat", "cost": 150, "nivell_dificultat": 2},
    {"id": 3, "nom": "Avançat en Intel·ligència Emocional", "cost": 350, "nivell_dificultat": 2},
    {"id": 4, "nom": "Diploma en Resolució de Conflictes", "cost": 700, "nivell_dificultat": 3},
    {"id": 5, "nom": "Màster en Negociació Estratègica", "cost": 1200, "nivell_dificultat": 3},
    {"id": 6, "nom": "Postgrau en Lideratge d'Equips", "cost": 2500, "nivell_dificultat": 4},
]

# --- BANC DE 120 PREGUNTES COMPLET ---
PREGUNTES_HABILITATS = [
    # --- NIVELL 1 (30 preguntes) ---
    {"pregunta": "¿Quina és la millor manera d'escoltar activament?", "opcions": ["Interrompre", "Mirar al mòbil", "Fer contacte visual i assentir", "Planificar la resposta"], "resposta_correcta": "Fer contacte visual i assentir", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Escolta Activa"},
    {"pregunta": "¿Com respons a una crítica constructiva?", "opcions": ["Defensivament", "Ignorant-la", "Agraint i preguntant com millorar", "Criticant a l'altre"], "resposta_correcta": "Agraint i preguntant com millorar", "eco_guany": 20, "eco_perdua": 5, "dificultat": 1, "categoria": "Feedback"},
    ...
    {"pregunta": "Com reacciones a un elogi?", "opcions": ["Minimitzar-lo", "Acceptar-lo amb un 'gràcies' sincer", "Pensar que és fals", "Respondre amb un elogi forçat"], "resposta_correcta": "Acceptar-lo amb un 'gràcies' sincer", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Assertivitat"},
    {"pregunta": "L'element que verifica la comprensió del missatge és...", "opcions": ["El codi", "La retroalimentació (feedback)", "El soroll", "L'emissor"], "resposta_correcta": "La retroalimentació (feedback)", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Feedback"},
    {"pregunta": "Quina part del missatge té més impacte segons la majoria d'estudis?", "opcions": ["Les paraules exactes", "El to de veu", "El llenguatge corporal", "La velocitat en parlar"], "resposta_correcta": "El llenguatge corporal", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Què significa tenir una postura corporal 'oberta'?", "opcions": ["Braços creuats", "Mirar cap avall", "Braços descruzats i cos relaxat", "Estar d'esquena"], "resposta_correcta": "Braços descruzats i cos relaxat", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Per a què serveix principalment el contacte visual durant una conversa?", "opcions": ["Per intimidar", "Per mostrar interès i confiança", "Per distreure", "No té cap funció"], "resposta_correcta": "Per mostrar interès i confiança", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Què és un component cognitiu de les HH.SS.?", "opcions": ["La mirada", "La postura", "Les creences i pensaments", "El to de veu"], "resposta_correcta": "Les creences i pensaments", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "L'espai personal o 'proxèmica' es refereix a...", "opcions": ["El volum de la veu", "La distància física entre persones", "El temps que dura una conversa", "El lloc on es conversa"], "resposta_correcta": "La distància física entre persones", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Un gest com aixecar les espatlles indica generalment...", "opcions": ["Acord total", "Enfado", "Desconeixement o indiferència", "Entusiasme"], "resposta_correcta": "Desconeixement o indiferència", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Què és la 'paralingüística'?", "opcions": ["L'estudi de les paraules", "Els aspectes no verbals de la veu (to, ritme...)", "L'estudi dels gestos", "L'estudi de l'escriptura"], "resposta_correcta": "Els aspectes no verbals de la veu (to, ritme...)", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Un to de veu monòton pot transmetre...", "opcions": ["Passió i interès", "Autoritat i seguretat", "Nerviosisme i por", "Avorriment o falta d'interès"], "resposta_correcta": "Avorriment o falta d'interès", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Què és més important per a una comunicació efectiva?", "opcions": ["Parlar molt ràpid", "Utilitzar paraules complicades", "Que el missatge sigui clar i concís", "Parlar més alt que els altres"], "resposta_correcta": "Que el missatge sigui clar i concís", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "La primera impressió es forma principalment a partir de...", "opcions": ["El teu currículum", "La teva comunicació no verbal", "El que dius en els primers 10 minuts", "La teva roba"], "resposta_correcta": "La teva comunicació no verbal", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació No Verbal"},
    {"pregunta": "Com es defineix 'conducta' en el context de les HH.SS.?", "opcions": ["Només les accions bones", "La manera de comportar-se en una situació", "Els pensaments interns", "La personalitat"], "resposta_correcta": "La manera de comportar-se en una situació", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "El 'context' en la comunicació inclou...", "opcions": ["Només el lloc físic", "El lloc, el moment i la relació entre interlocutors", "Només la relació entre persones", "Només el tema de conversa"], "resposta_correcta": "El lloc, el moment i la relació entre interlocutors", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "Què és un component emocional de les HH.SS.?", "opcions": ["El gest de les mans", "La gestió de la pròpia ira", "Les paraules utilitzades", "Les idees preconcebudes"], "resposta_correcta": "La gestió de la pròpia ira", "eco_guany": 15, "eco_perdua": 5, "dificultat": 1, "categoria": "Intel·ligència Emocional"},
    {"pregunta": "L'habilitat de començar, mantenir i tancar converses és una habilitat...", "opcions": ["Purament cognitiva", "Conductual bàsica", "Emocional complexa", "Innecessària"], "resposta_correcta": "Conductual bàsica", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "Per què és important donar feedback?", "opcions": ["Per criticar als altres", "Per millorar la comunicació i el rendiment", "Per demostrar que saps més", "No és important"], "resposta_correcta": "Per millorar la comunicació i el rendiment", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Feedback"},
    {"pregunta": "Un exemple de canal de comunicació és...", "opcions": ["Una idea", "Una trucada telefònica", "Una emoció", "Una creença"], "resposta_correcta": "Una trucada telefònica", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},
    {"pregunta": "L'objectiu final de la comunicació és...", "opcions": ["Guanyar la discussió", "Transmetre un missatge que sigui comprès", "Parlar durant molt de temps", "Confondre al receptor"], "resposta_correcta": "Transmetre un missatge que sigui comprès", "eco_guany": 10, "eco_perdua": 5, "dificultat": 1, "categoria": "Comunicació Bàsica"},

    # --- NIVELL 2 (40 preguntes) ---
    {"pregunta": "Un company et demana ajuda urgent, però ja vas molt carregat. Quina és la resposta més assertiva?", "opcions": ["Dir 'sí' i treballar fins tard", "Dir 'no' sense explicacions", "Explicar que t'agradaria ajudar però ara no pots", "Criticar la seva planificació"], "resposta_correcta": "Explicar que t'agradaria ajudar però ara no pots", "eco_guany": 30, "eco_perdua": 10, "dificultat": 2, "categoria": "Assertivitat"},
    ...
    {"pregunta": "L'empatia és la capacitat de...", "opcions": ["Sentir pena", "Solucionar problemes aliens", "Comprendre i compartir els sentiments d'altres", "Estar sempre d'acord"], "resposta_correcta": "Comprendre i compartir els sentiments d'altres", "eco_guany": 30, "eco_perdua": 10, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    ...
    {"pregunta": "Quin estil de conducta utilitza el sarcasme i la ironia per expressar el seu descontent?", "opcions": ["Assertiu", "Passiu-Agressiu", "Passiu", "Agressiu directe"], "resposta_correcta": "Passiu-Agressiu", "eco_guany": 25, "eco_perdua": 10, "dificultat": 2, "categoria": "Assertivitat"},
    ...
    {"pregunta": "Una persona que sempre diu 'sí' a tot, encara que no vulgui, té un estil...", "opcions": ["Agressiu", "Assertiu", "Passiu", "Manipulador"], "resposta_correcta": "Passiu", "eco_guany": 20, "eco_perdua": 10, "dificultat": 2, "categoria": "Assertivitat"},
    {"pregunta": "Què és l'autoconeixement emocional?", "opcions": ["Ignorar les teves emocions", "Reconèixer i entendre les teves pròpies emocions", "Culpar els altres de com et sents", "Sentir només emocions positives"], "resposta_correcta": "Reconèixer i entendre les teves pròpies emocions", "eco_guany": 30, "eco_perdua": 10, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    {"pregunta": "La frase 'Em sento frustrat quan...' és un exemple de comunicació...", "opcions": ["Agressiva", "Passiva", "Assertiva (missatge Jo)", "Manipuladora"], "resposta_correcta": "Assertiva (missatge Jo)", "eco_guany": 35, "eco_perdua": 15, "dificultat": 2, "categoria": "Assertivitat"},
    {"pregunta": "La funció de l'alegria és principalment...", "opcions": ["De protecció", "De recuperació", "De motivació i afiliació", "D'evitació"], "resposta_correcta": "De motivació i afiliació", "eco_guany": 20, "eco_perdua": 10, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    {"pregunta": "Un amic arriba tard constantment. Una resposta assertiva seria:", "opcions": ["'Ets un impuntual, no tens respecte'", "'No passa res' (mentre estàs enfadat per dins)", "'Valoro la nostra amistat, però em sento poc respectat quan arribes tard. Podem intentar ser més puntuals?'", "'La pròxima vegada arribaré jo més tard'"], "resposta_correcta": "'Valoro la nostra amistat, però em sento poc respectat quan arribes tard. Podem intentar ser més puntuals?'", "eco_guany": 35, "eco_perdua": 15, "dificultat": 2, "categoria": "Assertivitat"},
    {"pregunta": "L'aversió (fàstic) té una funció de...", "opcions": ["Exploració", "Rebuig i protecció davant del que és perjudicial", "Crear vincles", "Atacar"], "resposta_correcta": "Rebuig i protecció davant del que és perjudicial", "eco_guany": 20, "eco_perdua": 10, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    {"pregunta": "Quin dret assertiu et permet equivocar-te?", "opcions": ["A ser el teu propi jutge", "A canviar d'opinió", "A cometre errades i ser-ne responsable", "A dir que no ho saps"], "resposta_correcta": "A cometre errades i ser-ne responsable", "eco_guany": 25, "eco_perdua": 10, "dificultat": 2, "categoria": "Assertivitat"},
    {"pregunta": "La capacitat de gestionar les teves emocions per assolir objectius es diu...", "opcions": ["Autocontrol emocional", "Repressió emocional", "Empatia", "Simpatia"], "resposta_correcta": "Autocontrol emocional", "eco_guany": 30, "eco_perdua": 15, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    {"pregunta": "Dir 'no' de manera assertiva implica...", "opcions": ["Ser groller", "Donar mil excuses falses", "Ser clar, breu i respectuós", "No tornar a parlar amb la persona"], "resposta_correcta": "Ser clar, breu i respectuós", "eco_guany": 30, "eco_perdua": 10, "dificultat": 2, "categoria": "Assertivitat"},
    {"pregunta": "La funció adaptativa de la tristesa és...", "opcions": ["Motivar-te a fer coses", "Ajudar a la recuperació i a demanar suport social", "Fer-te més fort", "Evitar problemes"], "resposta_correcta": "Ajudar a la recuperació i a demanar suport social", "eco_guany": 25, "eco_perdua": 10, "dificultat": 2, "categoria": "Intel·ligència Emocional"},
    # ... (20 preguntes més de nivell 2) ...

    # --- NIVELL 3 (30 preguntes) ---
    {"pregunta": "En una negociació, l'altra part es mostra agressiva. Què és aconsellable?", "opcions": ["Respondre igual", "Mantenir la calma i centrar-se en fets", "Acceptar les seves condicions", "Marxar"], "resposta_correcta": "Mantenir la calma i centrar-se en fets", "eco_guany": 60, "eco_perdua": 20, "dificultat": 3, "categoria": "Negociació"},
    {"pregunta": "Dos membres del teu equip tenen un conflicte obert. Quina és la teva primera acció com a líder?", "opcions": ["Ignorar-ho", "Canviar un d'ells de projecte", "Mediar en una reunió conjunta", "Demanar a RRHH que intervingui"], "resposta_correcta": "Mediar en una reunió conjunta", "eco_guany": 70, "eco_perdua": 25, "dificultat": 3, "categoria": "Gestió de Conflictes"},
    ...
    {"pregunta": "Un client es queixa de manera agressiva. Quina és la millor forma de respondre?", "opcions": ["Posar-se agressiu també", "Penjar el telèfon", "Escoltar activament, validar la seva emoció i buscar una solució", "Dir-li que no té raó"], "resposta_correcta": "Escoltar activament, validar la seva emoció i buscar una solució", "eco_guany": 70, "eco_perdua": 30, "dificultat": 3, "categoria": "Gestió de Conflictes"},
    {"pregunta": "Què és la tècnica de la 'boira' en assertivitat?", "opcions": ["Ignorar completament la crítica", "Donar la raó a l'altra persona en tot", "Acceptar parcialment la crítica sense posar-se a la defensiva", "Confondre a l'altra persona amb informació irrellevant"], "resposta_correcta": "Acceptar parcialment la crítica sense posar-se a la defensiva", "eco_guany": 60, "eco_perdua": 25, "dificultat": 3, "categoria": "Assertivitat"},
    {"pregunta": "Quina és la diferència clau entre persuasió i manipulació?", "opcions": ["No n'hi ha cap", "La persuasió busca un benefici mutu; la manipulació, només el propi", "La persuasió és il·legal", "La manipulació utilitza dades objectives"], "resposta_correcta": "La persuasió busca un benefici mutu; la manipulació, només el propi", "eco_guany": 65, "eco_perdua": 25, "dificultat": 3, "categoria": "Negociació"},
    # ... (22 preguntes més de nivell 3) ...

    # --- NIVELL 4 (20 preguntes) ---
    {"pregunta": "Has de comunicar una decisió impopular a l'equip. Quina és la millor estratègia?", "opcions": ["Enviar un email breu", "Ser transparent sobre les raons i mostrar empatia", "Demanar a un altre que ho faci", "Anunciar-ho divendres a última hora"], "resposta_correcta": "Ser transparent sobre les raons i mostrar empatia", "eco_guany": 90, "eco_perdua": 35, "dificultat": 4, "categoria": "Lideratge"},
    ...
    {"pregunta": "Com es fomenta la 'seguretat psicològica' en un equip?", "opcions": ["Castigant els errors", "Promovent competència extrema", "Creant un entorn on es pot parlar obertament sense por", "Prenent decisions sense consultar"], "resposta_correcta": "Creant un entorn on es pot parlar obertament sense por", "eco_guany": 120, "eco_perdua": 45, "dificultat": 4, "categoria": "Lideratge"},
...
st.markdown("""
    <style>
        ...
        :root {
            --primary-color: #0d47a1; --secondary-color: #1976d2; --accent-color: #4caf50; 
            --text-color: #212121; --light-text-color: #757575; --background-color: #f4f7f6; 
            --card-bg: #ffffff; --border-radius: 20px; --shadow: 0 10px 30px rgba(0,0,0,0.07);
        }
        html, body, [class*="st-emotion"] { font-family: 'Poppins', sans-serif; color: var(--text-color); background-color: var(--background-color); }
        h1, h2, h3, h5 { font-family: 'Poppins', sans-serif; font-weight: 700; color: var(--primary-color); }
        .app-header {
            background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%);
            color: white; padding: 2rem; border-radius: var(--border-radius);
            text-align: center; margin-bottom: 2rem; box-shadow: var(--shadow);
        }
        .app-header h1 { color: white; font-size: 2.5em; margin: 0; }
        .stat-card { background-color: var(--card-bg); border-radius: var(--border-radius); padding: 25px; box-shadow: var(--shadow); position: relative; overflow: hidden; border-left: 6px solid var(--primary-color); transition: all 0.3s ease; }
        ...
        .saldo-change.negative { color: #e53935; }
        ...
        .content-card, .dashboard-card { background-color: var(--card-bg); border-radius: var(--border-radius); padding: 35px; box-shadow: var(--shadow); min-height: 400px; }
        .stButton>button { background-image: linear-gradient(45deg, var(--primary-color) 0%, var(--secondary-color) 100%); color: white; border: none; border-radius: 12px; padding: 16px 30px; font-size: 1.1em; font-family: 'Poppins', sans-serif; font-weight: 600; width: 100%; transition: all 0.3s ease; margin-top: 15px; box-shadow: 0 4px 15px rgba(0, 77, 161, 0.3); }
        .stButton>button:hover { transform: translateY(-3px); box-shadow: 0 7px 20px rgba(0, 77, 161, 0.4); }
        .stButton>button:disabled { background-image: none; background-color: #bdbdbd; cursor: not-allowed; box-shadow: none; }
        .feedback-guany { color: var(--accent-color); font-weight: 600; font-size: 1.1em; }
        .feedback-perdua { color: #e53935; font-weight: 600; font-size: 1.1em; }
        .exam-item { display: flex; align-items: center; justify-content: space-between; gap: 15px; padding: 15px; border-radius: 12px; transition: all 0.2s; margin-bottom: 10px; border: 1px solid #e0e0e0; }
        .exam-item-details { display: flex; align-items: center; gap: 15px; }
        .exam-item.unlocked { border-left: 6px solid var(--accent-color); background-color: #f1f8e9; }
        .exam-item.locked { background-color: #fafafa; }
        .exam-icon { font-size: 1.8em; line-height: 1; color: var(--primary-color); }
        .exam-item.unlocked .exam-icon { color: var(--accent-color); }
        .exam-details p { font-weight: 600; margin: 0; color: var(--primary-color); }
        .exam-details span { font-size: 0.9em; color: var(--light-text-color); }
        .exam-item .stButton>button { width: auto; padding: 8px 20px; font-size: 0.9em; margin-top: 0; }
...
# --- CONTINGUT DE L'APP ---
st.markdown("<div class='app-header'><h1>ECO-Banc: Habilitats Professionals</h1></div>", unsafe_allow_html=True)
...
if st.session_state.preguntes_respostes > 0:
    ...
    with dash_col1:
        ...
        st.markdown(f"""
            ...
            <div class="stat-item"><span class="stat-label">Respostes Incorrectes</span><span class="stat-value" style="color: #e53935;">{total_respostes - correctes}</span></div>
        """, unsafe_allow_html=True)
